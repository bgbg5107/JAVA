...
%>
    ...
    <form action="../prodSearch.jsp" method="post">
        ...
        <navbar id="navber">
          ...
          <div class="menu_item">
              <a href="martPage.jsp?martName=emart" id="hover_event2" class="menu_item">이마트</a>
            </ul>
          </div>
          <div class="menu_item">
          	  <a href="martPage.jsp?martName=lotte" id="hover_event3" class="menu_item">롯데마트</a>
            </ul>
          </div>
           <div class="menu_item">
          	  <a href="martPage.jsp?martName=homeplus" id="hover_event4" class="menu_item">홈플러스</a>
            </ul>
          </div>
          <div class="menu_item">
